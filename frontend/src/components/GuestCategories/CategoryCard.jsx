...
export default function CategoryCard({ category, onClick }) {
  ...
  return (
    <div className="category-card-box" onClick={onClick}>
      <div className="category-card-header">
        <div className={`category-card-icon ${iconClass}`}>
          {renderIcon(iconType)}
        </div>
        <span className={`category-priority-badge ${getPriorityClass(priority)}`}>
          {priority} Priority
        </span>
      </div>
