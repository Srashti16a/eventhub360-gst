...
export default function GuestForm({ initialData, onSubmit, onCancel }) {
  const [formData, setFormData] = useState({
    ...
    // rsvp table
    rsvpStatus: 'pending', // maps to rsvp.status (yes/no/maybe)
    pax: 1, // rsvp.pax
    ...
    <form onSubmit={handleSubmit} className="guest-editor-form">
      <div className="form-grid">
        ...
        <div className="form-group">
          ...
          >
            ...
            <option value="maybe">Pending (Maybe)</option>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem', marginTop: '2rem' }}>
        ...
        <button type="submit" className="btn-primary">
          {initialData ? 'Save Changes' : 'Create Guest'}
        </button>
      </div>
    </form>
  );
